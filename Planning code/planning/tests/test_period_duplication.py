...
class TestRecurrencySlotGeneration(TestCommonPlanning):
    ...
    def setUpClass(cls):
        ...
        cls.recurrency = cls.env['planning_old.recurrency'].create({
            'repeat_interval': 1,
            'repeat_unit': 'week',
        })

        cls.env['planning_old.slot'].create({
