...
class PlanningSend(models.TransientModel):
    ...
    def action_send(self):
        # create the planning_old
        planning = self.env['planning_old.planning_old'].create({
    ...
    def action_publish(self):
        ...
        to_publish = self.env['planning_old.slot'].sudo().search(domain)
        to_publish.write({
            'is_published': True,
